...
from .views import shop_home_view, product_detail_view,basket_detail_view,add_item_to_cart_view,remove_item_from_cart_view,order_form_view,payment_process_view,payment_done_view,payment_error_view
...
urlpatterns = [
    ...
    path("test-payment-process/<str:fail_flag>",fake_payment_process_view,name='test_payment_process'),
