...
from .views import (add_item_to_cart_view, basket_detail_view, order_form_view,
                    payment_done_view, payment_error_view,
                    payment_process_view, product_detail_view,
                    remove_item_from_cart_view, shop_home_view)
