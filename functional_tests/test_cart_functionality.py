...
class TestShoppingCart(FunctionalTest):
    ...
    def test_can_navigate_to_a_product_and_place_in_shopping_basket(self):
        ...
        self.browser.find_element_by_xpath(
            '//*[@id="basket_table"]/tbody/tr[1]/td[5]/form/input[1]'
        ).click()
        ...
        self.browser.find_element_by_xpath(
            '//*[@id="product-card-container"]/div[1]/div[2]/small/a'
        ).click()
        ...
        inline_quantity_select = Select(
            self.browser.find_element_by_xpath(
                "/html/body/div/table/tbody/tr[2]/td[2]/form/select"
            )
        )
        inline_quantity_select.select_by_value("2")
        self.browser.find_element_by_xpath(
            "/html/body/div/table/tbody/tr[2]/td[2]/form/input[2]"
        ).click()
